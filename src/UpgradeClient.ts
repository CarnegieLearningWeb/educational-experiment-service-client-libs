...
export default class UpgradeClient {
    ...
    private group = null;
    private workingGroup = null;
    private experimentConditionData = null;
    ...
    async getAllExperimentCondition(context?: string): Promise<IExperimentAssignment[]> {
        this.validateClient();
    ...
    getExperimentCondition(experimentPoint: string, partitionId?: string): Interfaces.IGetExperimentCondition {
        this.validateClient();
